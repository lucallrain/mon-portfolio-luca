    ...
    <section id="about" className="about">
      <div className="about-content">
        ...
        <p className="about-description">
          Salut ! Je suis Luca Lelaurain, un développeur passionné par le monde
          du web. Je veux concevoir des sites web intuitifs, fonctionnels et
          attractifs, avec une attention particulière portée au design et à
          l’optimisation du parcours utilisateur.
        </p>
        <p className="about-description">
          Spécialisé dans le développement front-end, je maîtrise une variété de
          technologies modernes comme React, Tailwind CSS, et Next.js. Je
          dispose également de solides bases en back-end, ce qui me permet de
          travailler sur des projets full-stack lorsque nécessaire.
        </p>
        <p className="about-description">
          Mon objectif principal est de transformer vos idées en des projets
          uniques, tout en assurant un SEO optimal pour une meilleure visibilité
          en ligne. Chaque projet est pour moi une opportunité pour explorer de
          nouvelles approches et de repousser les limites de la créativité.
        </p>
